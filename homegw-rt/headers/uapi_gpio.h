...
// Generate const from defines
const __u32 GPIO_GET_CHIPINFO_IOCTL_C = GPIO_GET_CHIPINFO_IOCTL;
const __u32 GPIO_GET_LINEINFO_UNWATCH_IOCTL_C = GPIO_GET_LINEINFO_UNWATCH_IOCTL;

const __u32 GPIO_V2_GET_LINEINFO_IOCTL_C = GPIO_V2_GET_LINEINFO_IOCTL;
const __u32 GPIO_V2_GET_LINEINFO_WATCH_IOCTL_C = GPIO_V2_GET_LINEINFO_WATCH_IOCTL;
const __u32 GPIO_V2_GET_LINE_IOCTL_C = GPIO_V2_GET_LINE_IOCTL;
const __u32 GPIO_V2_LINE_SET_CONFIG_IOCTL_C = GPIO_V2_LINE_SET_CONFIG_IOCTL;
const __u32 GPIO_V2_LINE_GET_VALUES_IOCTL_C = GPIO_V2_LINE_GET_VALUES_IOCTL;
const __u32 GPIO_V2_LINE_SET_VALUES_IOCTL_C = GPIO_V2_LINE_SET_VALUES_IOCTL;
